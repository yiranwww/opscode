...
close all;
clear;
load('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\Result.mat');
...
filename = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\Training'];
...
filename = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\TestA'];
print('-dpng', filename, '-r150')
...
filename = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\TestB'];
print('-dpng', filename, '-r150')
...
filename = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\Validation'];
print('-dpng', filename, '-r150')