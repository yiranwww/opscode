...
load('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\Section_norm_data.mat');..., 'min_x_train', 'max_x_train', 'min_y_train', 'max_y_train', 'min_z_train', 'max_z_train');
...
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\png\X_',num2str(m)];
% print('-f1',figname,'-dpng')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\fig\X_',num2str(m),'.fig'];
% savefig(figname)
% 
% figure(2)
...
% set(gca,'FontSize',15,'FontWeight','bold')
% title(titlename,'FontSize',30);
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\png\Y_',num2str(m)];
% print('-f2',figname,'-dpng')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\fig\Y_',num2str(m),'.fig'];
% savefig(figname)
% 
% figure(3)
...
% title(titlename,'FontSize',30);
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\png\Z_',num2str(m)];
% print('-f3',figname,'-dpng')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\fig\Z_',num2str(m),'.fig'];
% savefig(figname)
% 
% figure(7)
...
% title(titlename,'FontSize',30);
% set(gca,'FontSize',20)
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\png\RelaX_',num2str(m)];
% print('-f7',figname,'-dpng')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\fig\RelaX_',num2str(m),'.fig'];
% savefig(figname)
% figure(8)
...
% set(gca,'FontSize',15,'FontWeight','bold')
% title(titlename,'FontSize',30);
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\png\RelaY_',num2str(m)];
% print('-f8',figname,'-dpng')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\fig\RelaY_',num2str(m),'.fig'];
% savefig(figname)
% figure(9)
...
% set(gca,'FontSize',15,'FontWeight','bold')
% title(titlename,'FontSize',30);
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\png\RelaZ_',num2str(m)];
% print('-f9',figname,'-dpng')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\fig\RelaZ_',num2str(m),'.fig'];
% savefig(figname)
% 
% figure(16)
...
% set(gca,'FontSize',15,'FontWeight','bold')
% title(titlename,'FontSize',30);
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\png\XErrorDis_',num2str(m)];
% print('-f16',figname,'-dpng')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\fig\XErrorDis_',num2str(m),'.fig'];
% savefig(figname)
% 
% figure(17)
...
% set(gca,'FontSize',15,'FontWeight','bold')
% title(titlename,'FontSize',30);
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\png\YErrorDis_',num2str(m)];
% print('-f17',figname,'-dpng')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\fig\YErrorDis_',num2str(m),'.fig'];
% savefig(figname)
% 
% figure(18)
...
% set(gca,'FontSize',15,'FontWeight','bold')
% title(titlename,'FontSize',30);
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\png\ZErrorDis_',num2str(m)];
% print('-f18',figname,'-dpng')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\fig\ZErrorDis_',num2str(m),'.fig'];
% savefig(figname)
% close all
% end
% 
...
% set(gca,'FontSize',15,'FontWeight','bold')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\png\RMSE_test'];
% print('-f19',figname,'-dpng')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\fig\RMSE_test.fig'];
% savefig(figname)
% 
% figure(20)
% subplot(3,1,1)
...
% set(gca,'FontSize',15,'FontWeight','bold')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\png\RMSE_train'];
% print('-f20',figname,'-dpng')
% figname = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\withValidation\256-11\activationtest\relu-relu\fig\RMSE_train.fig'];
% savefig(figname)
...
% figure()
% histogram(feature_1_vali)
% hold on
% histogram(feature_2_vali)
% histogram(feature_3_vali)
% % legengd('orbir 1', 'orbit 2', 'orbit 3')
%% save data
save('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\SavedFigure\WithSection\testfile\Result.mat')