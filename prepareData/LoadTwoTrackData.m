...
X_test_1 = [x_1_test_1; x_2_test_1; x_3_test_1; x_4_test_1; x_5_test_1];
X_test_2 = [x_1_test_2; x_2_test_2; x_3_test_2; x_4_test_2; x_5_test_2];
Y_test_1 = [y_1_test_1; y_2_test_1; y_3_test_1; y_4_test_1; y_5_test_1];
Y_test_2 = [y_1_test_2; y_2_test_2; y_3_test_2; y_4_test_2; y_5_test_2];
Z_test_1 = [z_1_test_1; z_2_test_1; z_3_test_1; z_4_test_1; z_5_test_1];
Z_test_2 = [z_1_test_2; z_2_test_2; z_3_test_2; z_4_test_2; z_5_test_2];
X_train_1 = [x_1_train_1; x_2_train_1; x_3_train_1; x_4_train_1; x_5_train_1];
X_train_2 = [x_1_train_2; x_2_train_2; x_3_train_2; x_4_train_2; x_5_train_2];
...
for i = 1:p
    for j = 1:length*2
        ...
        Norm_TestA(i, 2+3*(j-1)) = Test_norY(i,j);
        Norm_TestA(i, 3+3*(j-1)) = Test_norZ(i,j);
    end
end
...
for i = 1:p
    for j = 1:length*2
        ...
        Norm_TestB(i, 2+3*(j-1)) = Test_norY_b(i,j);
        Norm_TestB(i, 3+3*(j-1)) = Test_norZ_b(i,j);
    end
end
