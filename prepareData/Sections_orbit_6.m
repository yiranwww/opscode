   ...
   if size(i) > length
    ...
    name = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\TrainData\orbit_6\TrainData', num2str(i), '.mat'];
        save(name, 'UseData')
         ...
         variable1 = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\TrainData\orbit_6\TrainData', num2str(i), '.mat'];
      X = load(variable1);
      A = X.UseData;
      DataAll_1(i,:)=A;
   ...
   if size(i) > length
    ...
    name = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\TrainData\orbit_6\TrainData', num2str(i), '.mat'];
        save(name, 'UseData')
         ...
         variable2 = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\TrainData\orbit_6\TrainData', num2str(i), '.mat'];
      X = load(variable2);
      A = X.UseData;
      DataAll_2(i,:)=A;
   ...
   if size(i) > length
    ...
    name = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\TrainData\orbit_6\TrainData', num2str(i), '.mat'];
        save(name, 'UseData')
         ...
         variable3 = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\TrainData\orbit_6\TrainData', num2str(i), '.mat'];
      X = load(variable3);
      A = X.UseData;
      DataAll_3(i,:)=A;
...
save('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\TrainData\orbit_3\Section_orbit_6.mat', 'x_po', 'y_po', 'z_po');
...
for i = 1:p
   ...
   save('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\CollectTrainData\section_norm_data_orbit_6.mat',...
 ...
 csvwrite('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\CollectTrainData\section_result3_train_orbit_6.csv', DataAll);
 csvwrite('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\CollectTrainData\section_Normalized_result3_train_orbit_6.csv', Norm_DataAll);
...
save('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\CollectTrainData\section_Tensor_3part_train_orbit_6.mat', 'new_tensor');
