...
%     end
    ...
    name = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\TrainData\orbit_5\TrainData', num2str(i), '.mat'];
        save(name, 'UseData')
         ...
         variable = ['D:\ops\result_3\results-20200317\LSTM_MultiOrbits\TrainData\orbit_5\TrainData', num2str(i), '.mat'];
      X = load(variable);
      A = X.UseData;
      DataAll(i,:)=A;
...
save('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\TrainData\orbit_5\Data_orbit_5.mat', 'x_po', 'y_po', 'z_po');
a=-1; % lower
b=1; % higher
xall = x_po';
xall = xall(:);
...
for i = 1:p
 ...
 csvwrite('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\CollectTrainData\result3_train_orbit_5.csv', DataAll);
 csvwrite('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\CollectTrainData\Normalized_result3_train_orbit_5.csv', Norm_DataAll);
...
save('D:\ops\result_3\results-20200317\LSTM_MultiOrbits\CollectTrainData\Tensor_train_orbit_5.mat', 'new_tensor');
